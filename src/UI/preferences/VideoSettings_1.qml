...
SettingsPage {
	...
	property string _anotherVideoSource:        _videoSettings.anotherVideoSource.rawValue
    property bool   _isAnotherUDP264:           _isStreamSource && (_anotherVideoSource === _videoSettings.udp264VideoSource)
    property bool   _isAnotherUDP265:           _isStreamSource && (_anotherVideoSource === _videoSettings.udp265VideoSource)
    property bool   _isAnotherRTSP:             _isStreamSource && (_anotherVideoSource === _videoSettings.rtspVideoSource)
    property bool   _isAnotherTCP:              _isStreamSource && (_anotherVideoSource === _videoSettings.tcpVideoSource)
    property bool   _isAnotherMPEGTS:           _isStreamSource && (_anotherVideoSource === _videoSettings.mpegtsVideoSource)
	property bool   _requiresAnotherUDPPort:    _isAnotherUDP264 || _isAnotherUDP265 || _isAnotherMPEGTS
    ...
    SettingsGroupLayout {
		...
		LabelledFactComboBox {
            Layout.fillWidth:   true
            label:              "Vehicle Source" //! qsTr
            indexModel:         false
            fact:               _videoSettings.anotherVideoSource
            visible:            fact.visible
        }
    }
	...
	SettingsGroupLayout {
		id: anotherConnectionGroup
        Layout.fillWidth:   true
        heading:            "Another Connection" //! qsTr
        visible:            !_videoAutoStreamConfig && (_isAnotherTCP || _isAnotherRTSP | _requiresAnotherUDPPort)

		LabelledFactTextField {
            Layout.fillWidth:           true
            textFieldPreferredWidth:    _urlFieldWidth
            label:                      qsTr("RTSP URL")
            fact:                       _videoSettings.anotherRtspUrl
            visible:                    _isAnotherRTSP && _videoSettings.anotherRtspUrl.visible
        }
        ...
        LabelledFactTextField {
            ...
            label:                      qsTr("TCP URL")
            textFieldPreferredWidth:    _urlFieldWidth
            fact:                       _videoSettings.anotherTcpUrl
            visible:                    _isAnotherTCP && _videoSettings.anotherTcpUrl.visible
        }
        ...
        LabelledFactTextField {
            ...
            label:              		qsTr("UDP Port")
            textFieldPreferredWidth:    _urlFieldWidth
            fact:               		_videoSettings.anotherUdpPort
            visible:            		_requiresAnotherUDPPort && _videoSettings.anotherUdpPort.visible
        }
    }
